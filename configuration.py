...
class Configuration:
    def __init__(self):
        ...
        self.interpreter_path = '/home/chenjie/anaconda3/bin/python3'
        # path to the repository, suggest not editing it
        # self.repository_path = os.getcwd() + '/repo'
        self.repository_path = os.path.dirname(os.path.realpath(__file__)) + '/repo'
        # path to air puff force data
        # self.air_puff_path = os.getcwd() + '/air_puff.csv'
        self.air_puff_path = os.path.dirname(os.path.realpath(__file__)) + '/air_puff.csv'
        # ========================================================================
